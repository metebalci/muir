...
/// **The format is version 4, and a file of another version is refused by
...
/// the serial port's registers to the I/O board's, and version 4 the
/// instant the interval timer was loaded.
#[test]
fn the_format_is_version_4_and_another_version_is_refused() {
    assert_eq!(checkpoint::VERSION, 4, "a new version needs its own tests");
    ...
    assert_eq!(&good[at..at + 4], 4u32.to_le_bytes());
    for other in [1u32, 2, 3, u32::MAX] {
