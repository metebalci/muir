...
//!
//! It is in the gitignored `ref/band-1002-dev6` (muir-sys `51639ac`, contract Q2): boot
...
const BAND: &str = "ref/band-1002-dev6";

/// The size `band-1002-dev6` was built at; it takes whatever size the
