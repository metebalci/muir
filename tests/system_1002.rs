...
//!
//! It is in the gitignored `ref/band-1002-dev7` (muir-sys `8551830`, contract Q3): boot
...
const BAND: &str = "ref/band-1002-dev7";

/// The size `band-1002-dev7` was built at; it takes whatever size the
