...
| Document | What it is |
|---|---|
| `manual.md` | The manual: running muir, the start block, every command-line flag, flags in a file, the prompt, the terminal, what a run can write, the Chaosnet and the two-machine lashup |
